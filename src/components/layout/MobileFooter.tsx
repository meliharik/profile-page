  ...
  return (
    <div className="lg:hidden mt-12 pt-8 border-t border-white/20">
      <div className="text-center">
        <p className="text-sf-footnote font-sf-regular text-slate-600 mb-2 flex items-center justify-center gap-1">
          Made by Melih Arık
        </p>
        <p className="text-sf-footnote font-sf-regular text-slate-600 mb-4 flex items-center justify-center gap-1">
          with <Heart className="w-3 h-3 text-red-500 fill-current" /> and <Coffee className="w-3 h-3 text-amber-600" />
        </p>
